...
namespace Common
{
    ...
    public class Utils
    {
        ...
        /// <returns></returns>
        public static bool IsNumeric(object experssion)
        {
            if(experssion != null)
                return IsNumeric(experssion.ToString());
        ...
        /// <param name="experssion"></param>
        /// <returns></returns>
        public static bool IsNumeric(string experssion)
        {
            if (experssion != null)
            {
                string str = experssion;
        ...
        /// <param name="experssion"></param>
        /// <returns></returns>
        public static bool IsDouble(object experssion)
        {
            if (experssion != null)
                return Regex.IsMatch(experssion.ToString(), @"^([0-9])[0-9]*(\.\w*)?$");
